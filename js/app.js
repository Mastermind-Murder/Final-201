...
GamePlayCharacters.prototype.assignInfo = function () {
  ...
  let clue1E = `${this.playableCharacters[4].name} : Was at a charity event at the time of the murder, and several high-profile guests can confirm their presence. They also donated a significant sum of money that evening, which was documented.`;
  ...
  let clue1F = `${this.playableCharacters[5].name} : Was at a job interview at a law firm across town at the time of the murder, and the interviewer can confirm their presence. They also have a thank-you note from the interview as proof.`;
  ...
  let clue4F = `${this.playableCharacters[5].name} : Was seen arguing with the victim outside of a coffee shop near the crime scene on the day of the murder. They claim it was just a friendly disagreement, but witnesses saw them shouting and shoving.`;
